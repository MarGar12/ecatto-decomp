...
func _ready():
	...
	if bob == 1:
		$anim.play("bob2")
		#$bg2.modulate = Color(255.014, 255.014, 255.014, 0.647)
	if bob2 == 1:
		$earth_fk.hide()
		$space.hide()
		$moon.show()
		$particles.hide()
	if bob2 == 2:
		$logo/version.set("theme_override_colors/font_color", Color())
		$main/play.set("theme_override_colors/font_color", Color())
		$main/decompcredits.set("theme_override_colors/font_color", Color())
		$main/settings.set("theme_override_colors/font_color", Color())
		$main/credits.set("theme_override_colors/font_color", Color())
		$main/quit.set("theme_override_colors/font_color", Color())
		$earth_fk.show()
		$moon.hide()
		$space.hide()
		$particles.show()
		$bg2.modulate = Color(1.0, 1.0, 1.0, 0.529)
	if bob2 == 3:
		$earth_fk.hide()
		$moon.hide()
		$space.show()
